...
export class MyNotesService {
  dayOne:NoteProperties={ title:'Day one',date:'09-02-21', content:'lorem epsum is overated but that is still what is use tring to conserve my energy i guess from being creative on the english side',backCol:'info'};
